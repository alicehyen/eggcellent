...
var languageStrings = \{\
    'en': \{\
        'translation': \{\
            ...
            'ABOUT'   : "<s>Egg Cellent helps guide you through your egg-making, including hard-boiled, <prosody pitch='low'>soft-boiled</prosody>, sunny side up, <prosody pitch='x-low'>poached</prosody>, over easy, <prosody pitch='low'>over medium</prosody>, over hard fried eggs, and <prosody pitch='low'>scrambled</prosody>. </s><s>We are <say-as interpret-as='interjection'>hard</say-as> to <say-as interpret-as='interjection'>beat</say-as>.</s><s> Now don't be a <emphasis level='moderate'><prosody pitch='x-high'>chicken</prosody></emphasis>, and get <say-as interpret-as='expletive'>fucking</say-as><say-as interpret-as='interjection'>egg</say-as> cited!</s>",\
            'STOP'    : "<s> Ok, time to eggs it.</s><s> See you next fry day.</s><s> and have an <say-as interpret-as='interjection'>egg</say-as> straordinary day!</s>"\
        \}\
    \}\
\};\
\
...
\
    ...
    \
    'EggIntent': function () \{\
        var say = 'handling the egg name intent';\
        //I am yolking my brain to find some eggs to crack\
        \
         var EggName = '';\
        ...
        case 'poached egg':\
        case 'poached eggs':\
          say = '<prosody pitch="x-low"><s>At Excellent, we poach eggs by first heating a pot of water just shy of a rolling point. </s><s> Add a dash of vinegar if you have it.</s><s> Swirl the water in your pan to create a whirlpool, and then <emphasis level = "strong">carefully</emphasis> drop the egg into the center.</s><s> Continue swirling around the egg for <emphasis level = "strong">five</emphasis> minutes and then lift egg out with a slotted spoon.</s><s>There you have it, now you have poached eggs!</s></prosody>';\
          break;\
        case 'over hard':\
        case 'over hard egg':\
        case 'over hard eggs':\
        ...
        case 'over easy egg':\
        case 'over easy eggs':\
          say = '<prosody pitch="x-low"><s>At Excellent, we make runny over easy eggs by first cracking an egg directly into our greased pan on medium heat.  </s><s>Then fry it until the edges brown and flip.  </s><s>Be careful to keep the yolk in place, and only cook for a short time so it stays runny! </s><s>There you have it, a delectable runny egg. </s><s>So delicious. </s><s>You know, </s><s> this would really pair well with an open-faced avocado toast sandwich. </s><s><emphasis level="strong">Mmmmm</emphasis> tasty</s></prosody>';\
          break;\
        case 'sunny side up':\
        case 'sunny side up egg':\
        case 'sunny side up eggs':\
        case 'sunny':\
          say = '<prosody pitch="x-low"><s>At Excellent, we make our sunny side up eggs by cracking an egg directly into our greased pan on medium heat.  </s><s>Then fry it until the edges brown without flipping. </s><s>Remove from your pan when you are ready to enjoy.</s><s>There you have it, sunny side up eggs for a sunny or not-so-sunny day! </s><s>Time to toast some bread to top it all off!</s></prosody>';\
          break;\
        case 'scrambled':\
        case 'scrambled eggs':\
        case 'scramble':\
          say = '<prosody pitch="x-low"><s>At Excellent, we make our scrambled eggs by first cracking a couple eggs and mixing the whites and yolks together in a bowl.  </s><s>If you want, mix in a dash of milk. Add oil to your stove pan set on medium-high, and pour the eggs in, folding them repeatedly for four to five minutes while they cook.  </s><s>Add salt and pepper and some cheddar cheese or whatever cheese is in your fridge while you are at it. </s><s>There you have it, yolks and folks, some tasty scrambled eggs! </s><s>Remember to add some hot sauce if you are feeling spicy!</s></prosody>';\
          break;\
        case 'soft boiled':\
        ...
        case 'hard-boiled egg':\
        case 'hard-boiled eggs':\
          say = '<prosody pitch="x-low"><s>At Excellent, we make hard boiled eggs by first boiling a pot of water. </s><s>Drop the eggs in and wait ten to twelve minutes.  </s><s>Afterward, drop the eggs in an ice water bath for easier peeling. </s><s>There you have it, some hard boiled eggs!</s></prosody>';\
          break;\
          \
          default:\
